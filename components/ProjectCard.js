...
export default function ProjectCard({ title, location, priceRange, images }) {
  ...
  currentImage = currentImage?.photo_url || null;

  console.log("currentImage: ", currentImage);

  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden transition-colors group">
